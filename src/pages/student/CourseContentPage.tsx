...
export default function CourseContentPage() {
  ...
  const renderContent = () => {
    ...
    if (activeLesson.contentType === "video") {
      ...
      return <div className="bg-black rounded-lg overflow-hidden" style={{ aspectRatio: "16/9" }}><video src={videoUrl} controls controlsList="nodownload" onContextMenu={(e: React.MouseEvent) => e.preventDefault()} className="w-full h-full" /></div>;
    }
