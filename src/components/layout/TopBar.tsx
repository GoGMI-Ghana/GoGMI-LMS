  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-40">
      <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3.5 py-2 w-[360px]">
        ...
        <input type="text" placeholder="Search courses, lessons, resources..." className="border-none outline-none bg-transparent text-[13.5px] text-gray-700 w-full placeholder:text-gray-400" />
      </div>
      <div className="flex items-center gap-5">
        ...
        <button className="flex items-center gap-2.5 cursor-pointer">
          ...
          <div className="text-left">
            <div className="text-[13.5px] font-medium text-gray-800">{user.firstName} {user.lastName}</div>
            <div className="text-[11.5px] text-gray-500 capitalize">{user.role.toLowerCase()}</div>
          </div>
